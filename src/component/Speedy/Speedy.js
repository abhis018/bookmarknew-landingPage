...
const Speedy = ({onRouteChange}) => {
    return (
        <div>
            ...
            <div className="push">
                <button className="but grow">Simple Bookmarking</button>
                <button onClick={() => onRouteChange('easy')} className="but grow">Speedy Searching</button>
                <button className="but grow">Easy Sharing</button>
            </div><hr className="hr"/>
            <div className="box">
                <img className="box1" src={img2} width="800px" height="300px" alt=""/>
            ...
            <div className="last-1 tc bg-blue pa5 white">
                ...
                <button className="mh3 bg-red ba b--near-none br2 h2 w-10 b white grow shadow-2 f6">Contact Us</button>
           </div>
