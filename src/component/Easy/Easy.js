    ...
    return (
        <div>
            ...
            <div className="push">
                ...
                <button onClick={() => onRouteChange('simple')} className="but grow">Easy Sharing</button>
            </div><hr className="hr"/>
            <div className="box">
                <img className="box1" src={img3} width="800px" height="300px" alt=""/>
            ...
            <div className="block">
                <div className="ques-box">
                        ...
                        <div className="ques"><hr/>
                            <h4>What is Bookmark?
                            <span className="bi bi-dowm">^</span>
                            </h4>
                        </div>
                        {/* <!-- Answer 1 --> */}
                        <div className="ans">
